...
import (
	...
	// "github.com/cilium/cilium/slim-daemon/option"
)
...
func runDaemon() {
	...
	pod, err := k8s.Client().CoreV1().Pods("default").Get(context.Background(), "default", metav1.GetOptions{})
	fmt.Println(pod, err)
